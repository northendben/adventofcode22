...
for item in instructions:
    ...
    while count < box_count:
        ...
        hold_list.insert(0,box_being_moved)
        count+=1
    for box in hold_list:
        stack_dict[to_stack].append(box)
...
{1: ['N', 'C', 'R', 'T', 'M', 'Z', 'P'], 2: ['D', 'N', 'T', 'S', 'B', 'Z'], 3: ['M', 'H', 'Q', 'R', 'F', 'C', 'T', 'G'], 4: ['G', 'R', 'Z'], 5: ['Z', 'N', 'R', 'H'], 6: ['F', 'H', 'S', 'W', 'P', 'Z', 'L', 'D'], 7: ['W', 'D', 'Z', 'R', 'C', 'G', 'M'], 8: ['S', 'J', 'F', 'L', 'H', 'W', 'Z', 'Q'], 9: ['S', 'Q', 'P', 'W', 'N']}
